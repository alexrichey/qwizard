...
(def german
  [
   ...
   ;; articles
   {:name "der" :as-preposition "den" :plural "die" :akkusative-dein "deinen" :type :article}
   ...
   {:name "an"       :english "at or near" :type :preposition}
   {:name "vor"      :english "in front of" :type :preposition}
   {:name "zwischen" :english "in between" :type :preposition}
